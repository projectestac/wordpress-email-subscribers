        ...
        <div class="es-upper">
            <div class="es-info">
                <div class="es-about">
                    ...
                    if (empty($es_upgrade_to_4)) {
                        ...
                        <ul>
                            <strong><?php _e('Here\'s a quick look at changes within the plugin:', 'email-subscribers'); ?></strong>
                        ...
                        <a href="https://www.icegram.com/email-subscribers-plugin-redesign/?utm_source=es&utm_medium=in_app&utm_campaign=es_4"
                           target="_blank"
                           class="button button-main"><?php _e('Explore all changes', 'email-subscribers'); ?></a>
                    <?php } else if ('yes' === $ig_es_onboarding_complete) { ?>
                        <h2><?php echo __("You are all setup 👍", 'email-subscribers'); ?></h2>
                        <div class="es-notify-about-new-post-1">
                            <b><?php echo __('Here are the things you can do next', 'email-subscribers'); ?></b></div>
                        <ul>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="es-notify-about-new-post-1">
                            <b><?php echo __('Please read this carefully and make changes as needed', 'email-subscribers'); ?></b>
                        </div>
                        <ul>
                ...
                <div class="wrap klawoo-form">
                    <table class="form-table">
                        <tr>
                            <td colspan="3"
                                class="es-optin-headline"><?php echo __('Free Course - Email Marketing Mastery', 'email-subscribers'); ?></td>
                        </tr>
                        <tr>
                            <td class="es-emm-image"><img alt="Email Marketing Mastery"
                                                          src="<?php echo plugin_dir_url(dirname(__FILE__)); ?>images/email-marketing-mastery.png"/>
                            </td>
                            <td class="es-emm-text">
                                <b><?php echo __('In short 5 weeks: build your list and succeed with email marketing', 'email-subscribers'); ?></b>
                                <br/><br/>
                                <?php echo __('Do you want to build your list, keep off spam, write emails that people open and click through? Do you want to build your brand and nurture an amazing tribe?
												Enter your name and email on the form to get it all.', 'email-subscribers'); ?>
                                <br/><br/>
                            </td>
                            <td class="es-emm-optin">
                                <form name="klawoo_subscribe" action="#" method="POST" accept-charset="utf-8">
                                    ...
                                    <input class="es-ltr" type="text" name="email" id="email" placeholder="Your Email"
                                           required value="<?php echo $current_user_email; ?>"/> <br/>
                                    <input type="hidden" name="list" value="hN8OkYzujUlKgDgfCTEcIA"/>
                                    <input type="checkbox" name="es-gdpr-agree" id="es-gdpr-agree" value="1"
                                           required="required">
                                    ...
                                    <br/><br/>
                                    <input type="submit" name="submit" id="submit" class="button button-hero"
                                           value="<?php echo __('Subscribe', 'email-subscribers'); ?>">
                                    <br><br>
            ...
            <div class="es-right">
                ...
                <div class="es-quick-links-wrapper">
                    ...
                    <li class="es-quick-links"><a target="_blank"
                                                  href="<?php echo admin_url('admin.php?page=es_subscribers&filter_by_status=subscribed') ?>"><?php _e('Active Contacts', 'email-subscribers') ?></a>
                        <span class="es-count"><?php echo '- ' . $sub_count; ?> </span></li>
                    <li class="es-quick-links"><a target="_blank"
                                                  href="<?php echo admin_url('admin.php?page=es_forms') ?>"><?php _e('Forms', 'email-subscribers') ?></a><span
                                class="es-count"><?php echo '- ' . $total_forms; ?> </span></li>
                    <li class="es-quick-links"><a target="_blank"
                                                  href="<?php echo admin_url('admin.php?page=es_campaigns') ?>"><?php _e('Campaigns', 'email-subscribers') ?></a><span
                                class="es-count"><?php echo '- ' . $total_campaigns; ?> </span></li>
                    <li class="es-quick-links"><a target="_blank"
                                                  href="<?php echo admin_url('admin.php?page=es_lists') ?>"><?php _e('Lists', 'email-subscribers') ?></a><span
                                class="es-count"><?php echo '- ' . $total_lists; ?> </span></li>
                </div>
                <div class="es-docs-wrapper">
                    <h3 class="es-right-headline"><?php _e('Help & How to\'s', 'email-subscribers'); ?></h3>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/documentation/how-to-create-form-in-email-subscribers/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('How to create and show subscription forms.', 'email-subscribers'); ?></a>
                    </li>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/documentation/es-how-to-create-and-send-post-notification-emails-when-new-posts-are-published/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('How to create a new campaign for new blog post ', 'email-subscribers'); ?></a>
                    </li>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/documentation/how-to-create-new-template-for-post-notification-or-broadcast/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('How to create new template for Post Notification or Broadcast', 'email-subscribers'); ?></a>
                    </li>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/documentation/es-how-to-create-and-send-newsletter-emails/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('How to Create and Send Broadcasts Emails', 'email-subscribers'); ?></a>
                    </li>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/documentation/es-how-does-sync-work/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('How to add WordPress users to your lists', 'email-subscribers'); ?></a>
                    </li>
                    <li class="es-doc-links"><a target="_blank"
                                                href="https://www.icegram.com/knowledgebase_category/email-subscribers/?utm_source=es&utm_medium=in_app&utm_campaign=view_docs_help_page"><?php _e('All Documentation', 'email-subscribers'); ?></a>
                    </li>
                </div>
                <?php
                // XTEC ************ AFEGIT - Hidden unnecessary info to all users but xtecadmin
                ...
                ?>
                    <div class="es-facebook column">
                        <p>
                            <strong><?php _e('<span>Join our</span> Email Subscribers Secret Club!', 'email-subscribers'); ?></strong>
                        </p>
                        ...
                        <p style="text-align: center;"><a style="text-decoration: none" target="_blank"
                                                          href="https://www.facebook.com/groups/2298909487017349/"><i
                                        class="dashicons dashicons-es dashicons-facebook"></i></a></p>
                    </div>
                <?php
                }
                // *********FI
                ...
                <div class="es-lower">
                    ...
                    if (is_xtec_super_admin()) {
                        ...
                        <a href="https://wordpress.org/support/plugin/email-subscribers"
                           target="_blank"><?php echo __('Contact Us', 'email-subscribers'); ?></a>
                    <?php
                    }
                    // *********FI
                    ?>
