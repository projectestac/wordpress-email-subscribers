            ...
            <div class="es-upper">
                <div class="es-info">
                    ...
                    <div class="es-quick-links-wrapper">
                        ...
                        <span class="es-quick-links"><a target="_blank"
                                                        href="<?php echo admin_url( 'admin.php?page=es_subscribers' ) ?>"><?php _e( 'Audience', 'email-subscribers' ) ?></a></span>
                        <span class="es-quick-links"><a target="_blank"
                        ...
                        <span class="es-quick-links"><a target="_blank"
                                                        href="<?php echo admin_url( 'admin.php?page=es_reports' ) ?>"><?php _e( 'Reports', 'email-subscribers' ) ?></a></span>
                    </div>
                    <div class="es-help-wrap">
                        <div class="subscribe-form">
                            ...
                            <ul>
                                ...
                                <li><?php echo __( 'Paste below PHP code to your desired location :', 'email-subscribers' ); ?>
                                    <p>
                                        <code><?php echo esc_html( '<?php es_subbox($namefield = "YES", $desc = "", $group = "Public"); ?>' ); ?></code>
                                    </p></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="wrap klawoo-form">
                    <table class="form-table">
                        <tr>
                            <td colspan="3"
                                class="es-optin-headline"><?php echo __( 'Build your list and succeed with email marketing <div>in 5 short weeks</div>', 'email-subscribers' ); ?></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="es-emm-image"><img alt="Email Marketing Mastery"
                        ...
                        <tr>
                            <td colspan="3" class="es-emm-text">
                                ...
                                <p>
                                    <b><?php echo __( 'Enter your name and email on the form to get it all.', 'email-subscribers' ); ?></b>
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3" class="es-emm-text">
                                <div class="column">
                                    <p>
                                        <strong><?php _e( '<span style="color:#ff6f7b">Join our</span> Email Subscribers Secret Club!', 'email-subscribers' ); ?></strong>
                                    </p>
